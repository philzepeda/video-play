...
s.linkInternalFilters="javascript:,nbcnews.com,interactive.nbcnews.com,.nbcnews.com";
...
function s_doPlugins() {
  s.eVar35 =s.getVisitNum();
  
  var currentDate = new Date();
  var year = currentDate.getFullYear();
  s.eVar12 = s.getTimeParting('h', '-5', year); // Set hour 
  s.eVar13 = s.getTimeParting('d', '-5', year); // Set day
  s.eVar14 = s.getTimeParting('w', '-5', year); // Set Weekend / Weekday
  s.eVar15 = currentDate.getTimezoneOffset()/60; //set timezone offset - check SDR - listed as deprecated.
}
